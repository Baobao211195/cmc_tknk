...
public class BCT_BO_NGANH_TGXN_MH_CAFEDTO {
	...
	public BCT_BO_NGANH_TGXN_MH_CAFEDTO(String lOAI_XN, int tHANG_BC,
			int nAM_BC, String nUOC_XX, String nUOC_NK, String mA_HANGKB,
			String tEN_HANG, String tEN_DVT, double lUONG_TK,
