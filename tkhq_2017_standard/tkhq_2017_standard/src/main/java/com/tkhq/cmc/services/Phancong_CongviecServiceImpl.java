...
public class Phancong_CongviecServiceImpl implements Phancong_CongviecService {
	...
	public Integer createPhancong(TbdSysPhancongCvDTO entity) {
		return tbdSysPhancongCvDAO.createPhancong(entity);
	...
	public List<TbdSysUserPhancongCvDTO> getListUserOfTongCuc (){
		return tbdSysPhancongCvDAO.getListUserOfTongCuc();
	}
	
	public TbdSysPhancongCvDTO getPhanCongByStt (int stt, String typNhapxuat) {
		return tbdSysPhancongCvDAO.getPhanCongByStt(stt, typNhapxuat);
	}
