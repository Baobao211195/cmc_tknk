...
public class BCT_BO_NGANH_TGXK_GIAYDEP_LH_DOANHNGHIEPDTO {
	private String LOAI_XN;
	private int KY_BC;
	private int THANG_BC;
	private int NAM_BC;
	private String TENLH_DN;
	...
	public void setKY_BC(int kY_BC) {
		KY_BC = kY_BC;
	}
	...
	public String getTENLH_DN() {
		return TENLH_DN;
	}
	public void setTENLH_DN(String tENLH_DN) {
		TENLH_DN = tENLH_DN;
	}
