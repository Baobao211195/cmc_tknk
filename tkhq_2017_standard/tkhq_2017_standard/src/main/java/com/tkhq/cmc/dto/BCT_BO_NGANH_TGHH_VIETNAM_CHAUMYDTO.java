...
public class BCT_BO_NGANH_TGHH_VIETNAM_CHAUMYDTO {
	...
	public BCT_BO_NGANH_TGHH_VIETNAM_CHAUMYDTO(String lOAI_XN,
			String tEN_THI_TRUONG, int tHANG_BC, int nAM_BC, String nUOC_XX,
			String nUOC_NK, String tEN_HANG, String tEN_DVT, double lUONG_TK,
