...
public class BCNKHHPTVT026HDTO {
	private int ky;
	private int nam;
	private String loai;
	...
	public BCNKHHPTVT026HDTO(int ky, int nam, String loai, String ma_nhom,
			String ten_hang, String ten_dvt, String ten_nuoc, String ma_ptvt,
			String ten_ptvt, double luong, double trigia_usd) {
		super();
		this.ky = ky;
		this.nam = nam;
		this.loai = loai;
	...
	public void setTrigia_usd(double trigia_usd) {
		this.trigia_usd = trigia_usd;
	}
