...
public class BCXKMHCYTPTVTTCHQQUYDTO {
	private int quy;
	private int nam;
	...
	public BCXKMHCYTPTVTTCHQQUYDTO(int quy, int nam, String ma_ptvt,
			String ten_ptvt, int stt, int sapxep, String ten_nhom,
			String ten_hang, String ten_dvt, double luong_ky, double trigia_ky,
			double luong_lk, double trigia_lk) {
		super();
		this.quy = quy;
		this.nam = nam;
