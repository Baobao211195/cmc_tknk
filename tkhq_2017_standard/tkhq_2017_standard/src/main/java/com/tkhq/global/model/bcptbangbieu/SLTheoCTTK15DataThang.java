...
public class SLTheoCTTK15DataThang {
	private String ss_thang_truoc=" ";
	private String ss_thang_nam_truoc=" ";
	private List<DataThangObj> data;
	public SLTheoCTTK15DataThang() {
		// TODO Auto-generated constructor stub
		data = new ArrayList<DataThangObj>();
	}
	public SLTheoCTTK15DataThang(String ss_thang_truoc, String ss_thang_nam_truoc, List<DataThangObj> data) {
