...
public class SLTheoCTTK08DataThang {
	private List<DataThangObj> data;
	private String ss_thang_truoc=" ";
	private String ss_thang_nam_truoc=" ";
	private String trend=" ";
	private String forecast=" ";
	public SLTheoCTTK08DataThang() {
		// TODO Auto-generated constructor stub
		data = new ArrayList<DataThangObj>();
	}
	public SLTheoCTTK08DataThang(List<DataThangObj> data, String ss_thang_truoc, String ss_thang_nam_truoc,
