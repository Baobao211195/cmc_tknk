...
public class SLTheoCTTK02DataThang {
	...
	public SLTheoCTTK02DataThang() {
		// TODO Auto-generated constructor stub
		data = new ArrayList<DataThangObj>();
	}
	public SLTheoCTTK02DataThang(List<DataThangObj> data, String ss_thang_truoc, String ss_thang_nam_truoc, String trend,
			String forecast) {
		super();
		this.data = data;
