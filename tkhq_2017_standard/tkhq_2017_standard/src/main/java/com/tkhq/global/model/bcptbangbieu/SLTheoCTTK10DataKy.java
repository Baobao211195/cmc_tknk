...
public class SLTheoCTTK10DataKy {
	private String ss_ky_truoc=" ";
	private String ss_ky_nam_truoc=" ";
	private String trend=" ";
	private String forecast=" ";
	private List<DataKyObj> data;
	public SLTheoCTTK10DataKy() {
		// TODO Auto-generated constructor stub
		data = new ArrayList<DataKyObj>();
	}
	public SLTheoCTTK10DataKy(String ss_ky_truoc, String ss_ky_nam_truoc, String trend, String forecast,
			List<DataKyObj> data) {
