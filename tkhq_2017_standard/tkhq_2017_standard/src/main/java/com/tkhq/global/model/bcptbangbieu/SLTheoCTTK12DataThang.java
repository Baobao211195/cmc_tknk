...
public class SLTheoCTTK12DataThang {
	private List<DataThangObj> data;
	private String ss_thang_truoc=" ";
	private String ss_thang_nam_truoc=" ";
	public SLTheoCTTK12DataThang() {
		// TODO Auto-generated constructor stub
		data = new ArrayList<DataThangObj>();
	}
	public SLTheoCTTK12DataThang(List<DataThangObj> data, String ss_thang_truoc, String ss_thang_nam_truoc) {
		this.data = data;
