...
public class SLTheoCTTK02DataKy {
	...
	public SLTheoCTTK02DataKy() {
		// TODO Auto-generated constructor stub
		data = new ArrayList<DataKyObj>();
	}
	public SLTheoCTTK02DataKy(List<DataKyObj> data, String ss_ky_truoc, String ss_ky_nam_truoc, String trend,
			String forecast) {
		super();
		this.data = data;
