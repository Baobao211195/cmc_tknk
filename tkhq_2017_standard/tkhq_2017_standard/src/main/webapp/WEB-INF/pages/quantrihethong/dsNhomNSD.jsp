	...
	<section class="content">
		<form name="searchForm" ng-submit="submitForm()" novalidate>
			<table style="width: 100%; margin: 10px 10px 10px 10px;">
				<tr>
					<td class="col-md-4"><label class="col-md-4">Tên viết tắt:
					</label>
						<div class="col-md-8">
							<input type="text" name="userName" class="form-control"
								ng-pattern="/^[a-zA-Z0-9_]*$/" ng-model="groupCode" /> <span
								class="error " ng-show="searchForm.userName.$error.pattern">Tên viết tắt không được có ký tự đặc biệt</span>
						</div></td>
					...
					<table id="example" class="table table-striped table-bordered"
						...
						<thead>
							<tr>
								...
								<th align="center" class="col-md-3">Tên viết tắt</th>
