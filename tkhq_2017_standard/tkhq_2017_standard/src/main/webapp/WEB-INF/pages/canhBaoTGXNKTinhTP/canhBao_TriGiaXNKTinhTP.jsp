...
<script src="<c:url value='/static/js/controller/canhBao_TriGiaXNKTinhTPController.js' />"></script>
...
<div ng-app="myApp" class="content-wrapper">
	<section class="content-header">
		<h3 class="title">Hiển thị và cảnh báo bất thường của diễn biến về trị giá xuất nhập khẩu của tỉnh, thành phố</h3>
	</section>
	<section class="content">
		<div class="modal-body" ng-controller="CanhBao_TriGiaXNKTinhTPController as ctrl">
			...
			<div class="" ng-if="showGrid">
				<%@ include file="canhBao_TriGiaXNKTinhTP_tab.jsp"%>
			</div>
