...
<script
	src="<c:url value='/static/js/service/tbsQtacXuatxuHangnhapService.js'/>"></script>
<script
	src="<c:url value='/static/js/controller/tbsQtacXuatxuHangnhapController.js'/>"></script>
	
<script src="<c:url value='/static/js/service/tbsDmQtacService.js' />"></script>

<div ng-controller="tbsQtacXuatxuHangnhapController">
