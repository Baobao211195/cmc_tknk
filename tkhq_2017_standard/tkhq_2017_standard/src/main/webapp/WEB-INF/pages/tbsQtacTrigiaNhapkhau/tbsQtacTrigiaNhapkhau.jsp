...
<script src="<c:url value='/static/js/service/tbsQtacTrigiaNhapkhauService.js'/>"></script>
<script src="<c:url value='/static/js/controller/tbsQtacTrigiaNhapkhauController.js'/>"></script>

<script src="<c:url value='/static/js/service/tbsDmQtacService.js' />"></script>

<div ng-controller="tbsQtacTrigiaNhapkhauController">
		...
		<fieldset class="form-group">
			<form class="form-search">
				<div class="col-md-12">
					...
					<div class="col-md-6 mab10">
						<label class="col-sm-3 pa0">Trị giá tính thuế:</label>
						<div class="col-sm-7 pa0">
							<input type="number" class="form-control" id="trigiatinhthue" ng-model="dto.trigiatinhthue" />
						</div>
					</div>
				</div>
	...
	<div ng-show="isDisplay">
		...
		<table id="tbsQtacTrigiaNhapkhau"
			class="table table-bordered table-striped table-responsive">
			<thead>
				<tr>
					<th>STT</th>
					<th width="40%">Mã thống kê</th>
					<th width="40%">Trị giá tính thuế</th>
					<th width="13%"></th>
				</tr>
			</thead>
			<tbody>
				<tr ng-repeat="row in listData">
					...
					<td align="left" width="40%" >{{row.trigiatinhthue | number}}</td>
