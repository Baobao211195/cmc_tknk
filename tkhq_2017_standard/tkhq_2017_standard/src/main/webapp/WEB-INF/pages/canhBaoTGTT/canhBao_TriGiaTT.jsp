...
<script src="<c:url value='/static/js/controller/canhBao_TriGiaTTController.js' />"></script>
...
<div ng-app="myApp" class="content-wrapper">
	<section class="content-header">
		<h3 class="title">Hiển thị và cảnh báo bất thường của diễn biến về trị giá theo thị trường, khối kinh tế</h3>
	</section>
	<section class="content">
		<div class="modal-body" ng-controller="CanhBao_TriGiaTTController as ctrl">
			...
			<div class="" ng-if="showGrid">
				<%@ include file="canhBao_TriGiaTT_tab.jsp"%>
			</div>
