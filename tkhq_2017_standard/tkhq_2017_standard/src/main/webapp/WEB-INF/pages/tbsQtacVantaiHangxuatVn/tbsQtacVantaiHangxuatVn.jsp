...
<script
	src="<c:url value='/static/js/service/tbsQtacVantaiHangxuatVnService.js'/>"></script>
<script
	src="<c:url value='/static/js/controller/tbsQtacVantaiHangxuatVnController.js'/>"></script>
<script src="<c:url value='/static/js/service/tbsDmQtacService.js' />"></script>

<div ng-controller="tbsQtacVantaiHangxuatVnController">
