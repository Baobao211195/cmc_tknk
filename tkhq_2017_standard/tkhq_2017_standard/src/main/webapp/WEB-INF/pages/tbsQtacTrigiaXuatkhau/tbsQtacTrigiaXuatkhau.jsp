...
<script src="<c:url value='/static/js/service/tbsQtacTrigiaXuatkhauService.js'/>"></script>
<script src="<c:url value='/static/js/controller/tbsQtacTrigiaXuatkhauController.js'/>"></script>

<script src="<c:url value='/static/js/service/tbsDmQtacService.js' />"></script>

<div ng-controller="tbsQtacTrigiaXuatkhauController">
