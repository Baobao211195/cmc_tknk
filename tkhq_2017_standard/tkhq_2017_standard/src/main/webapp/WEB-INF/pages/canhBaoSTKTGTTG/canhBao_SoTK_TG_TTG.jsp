...
<script src="<c:url value='/static/js/controller/canhBao_SoTKTTGController.js' />"></script>
...
<div ng-app="myApp" class="content-wrapper">
	<section class="content-header panel panel-success">
		<h5 class="title">Hiển thị và cảnh báo bất thường của diễn biến số tờ khai, trị giá theo ngày, tuần,
			tháng, quý, năm(làm việc, nghỉ)</h5>
	</section>
	<section class="content">
		<div class="form-group form-wrapper" ng-controller="CanhBao_SoTKTTGController as ctrl">
			...
			<%@ include file="canhBao_SoTK_TG_TTG_tab.jsp"%>
			</div>
			<br />
			<br />
