...
<script
	src="<c:url value='/static/js/service/tbsQtacVantaiHangnhapVnService.js'/>"></script>
<script
	src="<c:url value='/static/js/controller/tbsQtacVantaiHangnhapVnController.js'/>"></script>
<script src="<c:url value='/static/js/service/tbsDmQtacService.js' />"></script>	

<div ng-controller="tbsQtacVantaiHangnhapVnController">
		...
		<fieldset class="form-group">
			<form class="form-search">
				<div class="col-md-12">
					...
					<div class="col-md-6 mab10">
						<label class="col-sm-5 pa0">Mã cửa khẩu trong nước:</label>
						<div class="col-sm-5 pa0">
							<input type="text" class="form-control" id="macuakhauvn" ng-model="dto.macuakhauvn" />
						</div>
					</div>
				</div>
		...
		<table id="tbsQtacTrigiaXuatkhau"
			...
			<thead>
				<tr>
					...
					<th width="40%">Mã cửa khẩu trong nước</th>
					<th width="13%"></th>
				</tr>
			</thead>
			<tbody>
				<tr ng-repeat="row in listData">
					...
					<td align="left"  width="40%" ng-bind="row.macuakhauvn"></td>
