...
<div class="content-wrapper" ng-app="myApp" ng-controller="TabsDemoCtrl">
	...
	<h5 class="title">Hiển thị và cảnh báo bất thường của diễn biến về
		lượng, đơn giá, trị giá của các doanh nghiệp FDI</h5>
	</section>
	...
	<script src="<c:url value='/static/js/controller/dienBienSLDoanhNghiepFDIController_chart.js' />"></script>
	...
	<div class="generic-container"
		ng-controller="dienBienSLDoanhNghiepFDIController_chart as SLDoanhNghiepFDICtrl">
		<%@ include file="dienBienSLDoanhNghiepFDI_chart.jsp"%>
	</div>
	</section>
</div>
