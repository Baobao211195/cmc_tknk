...
myApp.controller('tbsQtacVantaiHangnhapNnController', ['$scope',
        ...
        $scope.doAdd = function () {
            ...
            validateMaPtVc($scope.dto.maphuongthucvanchuyen, $scope.dto.macuakhaunn);
...
//            valiDateMaCkNn($scope.dto.macuakhaunn);
        ...
        function validateMaPtVc(maTk, macuakhaunn){
        	if (maTk === ""){
            ...
            if(tbsDmQtacService.validateMa(macuakhaunn)){
        		$PopupMessage.Error("Mã cửa khẩu nước ngoài không được quá 20 ký tự");
        		return false;
        	}
