...
arrowimages: {down:['downarrowclass', './static/images/down.gif', 23], right:['rightarrowclass', './static/images/right.gif', 6], left:['leftarrowclass', './static/images/left.gif']},
...
//calculate this sub menu's offsets from its parent
					...
					if (setting.shadow){
						...
						$curobj.data('$shadow').css({overflow: 'visible', width:dimensions.subulw, left:shadowleft}).stop(true, true).animate({height:dimensions.subulh}, smoothmenu.transition.overtime);
					}
