    		...
    		.then(function(respone){        			
	    			...
	    			for(var i = 0; i < self.soLieuChiTieuTK.length; i++){
						for(var ii = 0; ii < self.soLieuChiTieuTK[i].group_data.length; ii++){
							...
							var lengthKY = self.soLieuChiTieuTK[i].group_data[ii].data_ky.data.length;
							var lengthTHANG = self.soLieuChiTieuTK[i].group_data[ii].data_thang.data.length;
							var tenKY = '';
							var tenTHANG = '';
//							if (self.soLieuChiTieuTK[i].group_data[ii].data_ky.data.length % 2 == 1) {
								lengthKY = self.soLieuChiTieuTK[i].group_data[ii].data_ky.data.length -1;
								lengthTHANG = self.soLieuChiTieuTK[i].group_data[ii].data_thang.data.length -1;
								tenKY = self.soLieuChiTieuTK[i].group_data[ii].data_ky.data[lengthKY].ky;
								tenTHANG = self.soLieuChiTieuTK[i].group_data[ii].data_thang.data[lengthTHANG].thang;
//							}
							...
							self.soLieuChiTieuTK[i].group_data[ii].data_ky["tenKY"] = tenKY;
							self.soLieuChiTieuTK[i].group_data[ii].data_thang["tenTHANG"] = tenTHANG;
						}
					}
