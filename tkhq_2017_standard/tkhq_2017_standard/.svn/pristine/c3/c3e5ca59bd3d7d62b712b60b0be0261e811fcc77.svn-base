...
public class SLTheoCTTK05DataThang {
	private List<DataThangObj> data;
	private String ss_thang_truoc;
	private String ss_thang_nam_truoc;
	private String trend;
	private String forecast;
	public SLTheoCTTK05DataThang() {
		// TODO Auto-generated constructor stub
		data = new ArrayList<DataThangObj>();
	}
	public SLTheoCTTK05DataThang(List<DataThangObj> data, String ss_thang_truoc, String ss_thang_nam_truoc,
