...
public class TMBCNKHH20TDTO {
	...
	public TMBCNKHH20TDTO( int thang, int nam, String loai, long stt,
			long sapxep, String ten_nhom, String ten_hang, String ten_dvt,
			double luong_ky, double trigia_ky, double luong_lk, double trigia_lk) {
		super();
		this.thang = thang;
		this.nam = nam;
		this.loai = loai;
