...
$(document).ready(function() {
	...
	for (var i = 0; i < elements.length; i++) {
	   elements[i].oninvalid =function(e) {
	        ...
	        switch(e.target.id){
	            case 'password' : 
	            e.target.setCustomValidity("Mật khẩu không được để trống");break;
	            case 'username' : 
	            e.target.setCustomValidity("Tài khoản không được để trống");break;
	...
	<div class="login">
		...
		<form name="form" ng-submit="vm.login()" role="form" method="POST"
			...
			<div class="validationDiv">
				<img width="352px" height="50px" src="/tkhq_2017_standard/captcha" />
			...
			<div>
				<input id="captchaCode" type="text" name="captchaCode" placeholder="Mã bảo mật"
