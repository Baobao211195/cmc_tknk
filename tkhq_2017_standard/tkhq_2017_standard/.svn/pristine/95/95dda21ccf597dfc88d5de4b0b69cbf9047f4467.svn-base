...
<div class="content-wrapper" ng-app="myApp" ng-controller="TabsDemoCtrl">
	...
	<h5 class="title">Hiển thị và cảnh báo bất thường của diễn biến số
		liệu theo định gốc, liên hoàn</h5>
	</section>
	...
	<script src="<c:url value='/static/js/controller/dienBienXuTheChiSoController_chart.js' />"></script>
	...
	<div ng-controller="dienBienXuTheChiSoController_chart as chiSoTKNNCtrl">
		<%@ include file="dienBienXuTheChiSo_chart.jsp"%>
	</div>
	</section>
</div>
