...
<script src="<c:url value='/static/js/angular-locale_vi-vn.js' />"></script>
<%-- <script src="<c:url value='/static/js/angular-messages.js' />"></script> --%>
...
<script src="<c:url value='/static/js/angular-fcsa-number.js' />"></script>
