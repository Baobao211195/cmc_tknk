...
<script src="<c:url value='/static/js/service/tbsQtacDnTrigiaXuatkhauService.js'/>"></script>
<script src="<c:url value='/static/js/controller/tbsQtacDnTrigiaXuatkhauController.js'/>"></script>
<script src="<c:url value='/static/js/service/tbsDmQtacService.js' />"></script>

<div ng-controller="tbsQtacDnTrigiaXuatkhauController">
		...
		<fieldset class="form-group">
			<form class="form-search">
				<div class="col-md-12" ng-show="!isCollapsed">
					...
					<div class="col-md-6 mab10">
						<label class="col-sm-4 pa0">Trị giá xuất khẩu:</label>
						<div class="col-sm-6 pa0">
							<input type="number" class="form-control" id="trigiaxuatkhau" ng-model="dto.trigiaxuatkhau" style="width: 311px;"/>
						</div>
					</div>
					<div class="col-md-6 mab10">
		...
		<table id="tbsQtacDnTrigiaXuatkhau"
			...
			<tbody>
				<tr ng-repeat="row in listData">
					...
					<td align="left">{{row.trigiaxuatkhau | number}}</td>
