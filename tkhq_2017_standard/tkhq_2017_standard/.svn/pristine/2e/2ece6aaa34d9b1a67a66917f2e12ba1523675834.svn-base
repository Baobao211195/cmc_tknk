...
<script src="<c:url value='/static/js/controller/canhBao_SLToKhaiXNKController.js' />"></script>
...
<div ng-app="myApp" class="content-wrapper ng-cloak">
	<section class="content-header">
		<h3 class="title">Hiển thị và cảnh báo bất thường của diễn biến của số lượng tờ khai theo Cục, Chi cục Hải quan</h3>
	</section>
	<section class="content">
		<div ng-controller="CanhBaoSLToKhaiXNKController as ctrl" class="modal-body">
			...
			<div class="" ng-if="showGrid">
				<%@ include file="canhBao_SLToKhaiXNK_tab.jsp"%>
			</div>
			
			<div class="" ng-if="showChart">
				<%@ include file="../canhBao_SLToKhaiXNK_chart/canhBao_SLToKhaiXNK_chart.jsp"%>
			</div>
		</div>
	</section>
	<div class="row">
