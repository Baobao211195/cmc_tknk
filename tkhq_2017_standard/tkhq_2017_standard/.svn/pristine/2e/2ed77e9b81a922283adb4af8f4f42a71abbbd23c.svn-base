...
<title>Phân tích dữ liệu tổng hợp sử dụng bảng biểu</title><!-- </head> -->
...
<section class="content-header panel panel-success">
	<h5 class="title">Hiển thị và cảnh báo bất thường của diễn biến về lượng, đơn
		giá, trị giá của các doanh nghiệp FDI</h5>
	</section>
	...
	<%@ include file="dienBienSLDoanhNghiepFDI.jsp"%>
