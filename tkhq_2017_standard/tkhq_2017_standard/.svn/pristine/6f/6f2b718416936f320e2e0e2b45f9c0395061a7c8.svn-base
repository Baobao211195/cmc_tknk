...
//	}
	...
	public int insertBatch(List<DuLieuFileCauTrucDto> listDuLieuFileCauTrucDto) {

		Session session = sessionFactory.openSession();
		Transaction tx = session.beginTransaction();

		for (int i = 0; i < listDuLieuFileCauTrucDto.size(); i++) {
			
			session.save(listDuLieuFileCauTrucDto.get(i));
