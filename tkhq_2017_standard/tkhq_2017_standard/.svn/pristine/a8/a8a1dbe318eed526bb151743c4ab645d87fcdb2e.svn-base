...
myApp.controller('tbsQtacLuongXuatkhauController', ['$scope',
                                                    '$PopupMessage',
                                                    'pagerService',
                                                    '$uibModal',
                                                    '$location',
...
//            checluongLn($scope.dto.luonglonnhat);
        ...
        function getDataById(id) {
            tbsQtacLuongXuatkhauService.GettbsQtacLuongXuatkhauById(id)
                .then(
                    function (deferred) {
                        if(deferred !== null){
                            copyData ($scope.listData ,id);
        ...
        function deleteData() {
            tbsQtacLuongXuatkhauService.DoDeletetbsQtacLuongXuatkhau(idDelete)
                .then(
                    function (deferred) {
                        if(deferred === 1){
        ...
        function addData(data) {
            tbsQtacLuongXuatkhauService.DoAddtbsQtacLuongXuatkhau(data)
                .then(
                    function (deferred) {
                        if(deferred === 1){
        ...
        function upDateData(data) {
            tbsQtacLuongXuatkhauService.DoUpdatetbsQtacLuongXuatkhau(data)
                .then(
                    function (deferred) {
                        if(deferred === 1){
        ...
        function search(currentPage, pageSize) {
            ...
            tbsQtacLuongXuatkhauService.SearchtbsQtacLuongXuatkhau(formData)
                .then(
                    function (deferred) {
...
//            tbsQtacLuongXuatkhauService.GetListtbsQtacLuongXuatkhau()
//                .then(
//                    function (deferred) {
//                        if (deferred !== null) {
//                            $scope.listData = deferred.content;
