...
<script src="<c:url value='/static/js/service/tbsQtacQuocgiaNghingoNkService.js'/>"></script>
<script src="<c:url value='/static/js/controller/tbsQtacQuocgiaNghingoNkController.js'/>"></script>
<script src="<c:url value='/static/js/service/tbsDmQtacService.js' />"></script>

<div ng-controller="tbsQtacQuocgiaNghingoNkController">
	...
	<div ng-show="isDisplay">
		...
		<table id="tbsQtacQuocgiaNghingoNk"
