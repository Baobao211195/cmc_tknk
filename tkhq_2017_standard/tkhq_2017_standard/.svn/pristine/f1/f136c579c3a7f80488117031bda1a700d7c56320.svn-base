...
public class SLTheoCTTK10DataThang {
	private String ss_thang_truoc=" ";
	private String ss_thang_nam_truoc=" ";
	private String trend=" ";
	private String forecast=" ";
	private List<DataThangObj> data;
	public SLTheoCTTK10DataThang() {
		// TODO Auto-generated constructor stub
		data = new ArrayList<DataThangObj>();
	}
	public SLTheoCTTK10DataThang(String ss_thang_truoc, String ss_thang_nam_truoc, String trend, String forecast,
			List<DataThangObj> data) {
