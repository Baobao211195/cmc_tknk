	...
	<div ng-show="isDisplay">
		...
		<table id="tbsQtacDongiaXuatkhau"
			...
			<thead>
				<tr>
					<th>STT</th>
					<th width="20%">Mã thống kê</th>
					<th width="30%">Đơn giá lớn nhất</th>
					<th width="30%">Đơn giá nhỏ nhất</th>
					<th width="13%"></th>
				</tr>
			</thead>
			<tbody>
				<tr ng-repeat="row in listData">
					...
					<td align="left" ng-bind="row.mathongke"></td>
					<td align="left">{{row.dongialonnhat | number}}</td>
					<td align="left">{{row.dongianhonhat | number}}</td>
