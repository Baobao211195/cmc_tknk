 ...
 */
@Entity
@Table(name = "TBS_MATHKE_NHOM_NK")
@XmlRootElement
public class TbsMathkeNhomNk implements Serializable {
    ...
    public TbsMathkeNhomNk() {
    }

    public TbsMathkeNhomNk(String maThke) {
        this.maThke = maThke;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TbsMathkeNhomNk)) {
            return false;
        }
        TbsMathkeNhomNk other = (TbsMathkeNhomNk) object;
    ...
    public String toString() {
        return "com.tkhq.cmc.model.TbsMathkeNhomNk[ maThke=" + maThke + " ]";
    }
