...
<div class="content-wrapper" ng-app="myApp" ng-controller="TabsDemoCtrl">
	...
	<h5 class="title">Hiển thị và cảnh báo bất thường của diễn biến tổng trị giá xuất nhập khẩu</h5>
	</section>
	<section class="content">
		...
		<script src="<c:url value='/static/js/controller/HTCBTGTXNKController_chart.js' />"></script> 
		...
		<div ng-controller="PhanHoiQuyTrinhXLDLController">
	 	...
	 	<div class="generic-container" ng-controller="HTCBTGTXNKController_chart as HTCBTGTXNKCtrl">
			<%@ include file="HTCBTGTXNK_chart.jsp"%>
		</div>
</section>
	</div>
