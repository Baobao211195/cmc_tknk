...
public class SLTheoCTTK11DataThang {
	private String ss_thang_truoc=" ";
	private String ss_thang_nam_truoc= " ";
	private List<DataThangObj> data;
	public SLTheoCTTK11DataThang() {
		// TODO Auto-generated constructor stub
		data = new ArrayList<DataThangObj>();
	}
	public SLTheoCTTK11DataThang(String ss_thang_truoc, String ss_thang_nam_truoc, List<DataThangObj> data) {
