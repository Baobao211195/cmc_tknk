...
<div class="content-wrapper" ng-app="myApp" ng-controller="TabsDemoCtrl">
	...
	<h5 class="title">Hiển thị và cảnh báo bất thường của diễn biến về
		lượng, đơn giá, trị giá mặt hàng</h5>
	</section>
	<section class="content">
	<form name="outerForm" class="tab-form-demo">
		<uib-tabset active="activeForm"> 
			<uib-tab 
				index="1" heading="Xuất khẩu" select="tabSelected1()"> 
			</uib-tab> 
			<uib-tab
				index="2" heading="Nhập khẩu" select="tabSelected2()"> 
			</uib-tab> </uib-tabset>
	</form>
	...
	<script src="<c:url value='/static/js/service/dienBienHangHoaXNKService.js' />"></script>
	<script src="<c:url value='/static/js/controller/dienbienHangHoaXNKController_chart.js' />"></script>
	...
	<div class= "modal-body"
		ng-controller="dienbienHangHoaXNKController_chart as dienBienHangHoaXNKCtrl">
		<%@ include file="dienBienHangHoaXNK_chart.jsp"%>
	</div>
	</section>
</div>
