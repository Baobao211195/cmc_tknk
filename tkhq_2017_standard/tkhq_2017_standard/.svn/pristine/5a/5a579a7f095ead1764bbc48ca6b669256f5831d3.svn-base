			...
			<form name="userForm" ng-submit="submitForm()" novalidate>
				...
				<div class="col-md-12" style="margin: 5px">
					<label class="col-md-3" style="margin-left: 50px">Mật khẩu
						cũ: </label>
					<div class="col-md-6">
						<input type="password" name="oldPass" class="form-control" ng-change="inputOldPass()"
				...
				<div class="col-md-12" style="margin: 5px">
					<label class="col-md-3" style="margin-left: 50px">Mật khẩu
						mới: </label>
					<div class="col-md-6">
						<input type="password" name="newPass" class="form-control" ng-change="inputNewPass()"
						ng-pattern="/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d\w)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,}[\w -]*$/"
							ng-model="newPass" ng-minlength="8"  ng-maxlength="255" ng-required=true /> <span
							class="error"
				...
				<div class="col-md-12" style="margin: 5px">
					<label class="col-md-3" style="margin-left: 50px">Xác nhận
						mật khẩu: </label>
					<div class="col-md-6">
						<input type="password" name="cfPass" ng-model="cfPass" ng-change="inputCfPass()"
