...
<script
	src="<c:url value='/static/js/service/tbsQtacVantaiHangxuatNnService.js'/>"></script>
<script
	src="<c:url value='/static/js/controller/tbsQtacVantaiHangxuatNnController.js'/>"></script>
<script src="<c:url value='/static/js/service/tbsDmQtacService.js' />"></script>

<div ng-controller="tbsQtacVantaiHangxuatNnController">
