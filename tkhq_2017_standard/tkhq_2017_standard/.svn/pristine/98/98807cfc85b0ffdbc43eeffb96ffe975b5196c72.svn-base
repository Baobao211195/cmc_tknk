...
public class Tbd_LichCB_TTTK implements Serializable{
    ...
    @Column(name = "KYBC")
    private Integer kyBC;
    
    @Column(name = "QUYBC")
    private Integer quyBC;
    ...
    @Column(name = "LOAIBCNB")
    private String loaiBCNB;

	public String getLoaiBCNB() {
		return loaiBCNB;
	}

	public void setLoaiBCNB(String loaiBCNB) {
		this.loaiBCNB = loaiBCNB;
	}
	...
	public Integer getKyBC() {
		return kyBC;
	}

	public void setKyBC(Integer kyBC) {
		this.kyBC = kyBC;
	}

	public Integer getQuyBC() {
		return quyBC;
	}

	public void setQuyBC(Integer quyBC) {
		this.quyBC = quyBC;
	}
