...
<section class="content">
	<div class="modal-body">
		<form name="userForm" ng-submit="submitForm()" novalidate>
				...
				<div class="col-md-4" ng-hide="controller.hideFromDate">
					...
					<div class="col-md-8">
						<input type="text" name="fromDate" class="form-control"
							...
							ng-click="open1()" is-open="popup1.opened"
							ng-change="changeDate()" /> <i
							class="fa fa-calendar form-control-feedback"
							style="z-index: 1; margin-top: -22px;"></i>
					</div>
				</div>
				<div class="col-md-4" ng-hide="controller.hideToDate">
					...
					<div class="col-md-8">
						<input type="text" name="toDate" class="form-control"
							...
							ng-change="changeDate()" datepicker-options="dateOptions"
							close-text="Close" required /><i
				...
				<div class="col-md-4" ng-hide="controller.hideFromMonth">
					...
					<div class="col-md-8">
						<input type="text" name="fromMonth" class="form-control"
							...
							ng-change="changeMonth()" is-open="popup3.opened"
							ng-click="open3()" datepicker-options="{minMode: 'month'}"
							datepicker-mode="month" close-text="Close" /> <i
				...
				<div class="col-md-4" ng-hide="controller.hideToMonth">
					...
					<div class="col-md-8">
						<input type="text" name="toMonth" class="form-control"
							...
							ng-change="changeMonth()" datepicker-options="{minMode: 'month'}"
							datepicker-mode="month" close-text="Close" /> <i
							class="fa fa-calendar form-control-feedback" ng-click="open4()"
							style="margin-top: -22px;"></i>
					</div>
				</div>
				<div class="col-md-4" ng-hide="controller.hideFromYear">
					...
					<div class="col-md-8">
						<input type="text" name="year" class="form-control"
							...
							ng-change="changeYear()" is-open="popup5.opened"
							datepicker-options="{minMode: 'year'}" ng-click="open5()"
							datepicker-mode="year" close-text="Close" /> <i
							class="fa fa-calendar form-control-feedback" ng-click="open5()"
							style="margin-top: -22px;"></i>
					</div>
				</div>
				<div class="col-md-4" ng-hide="controller.hideToYear">
					...
					<div class="col-md-8">
						<input type="text" name="year" class="form-control"
							...
							ng-change="changeYear()" is-open="popup6.opened"
							ng-click="open6()" datepicker-options="{minMode: 'year'}"
							datepicker-mode="year" close-text="Close" /> <i
							class="fa fa-calendar form-control-feedback" ng-click="open6()"
							style="margin-top: -22px;"></i>
					</div>
				</div>
			...
			<div align="center">
				<button class="btn btn-primary" ng-click="controller.showPopup()"
					ng-disabled="checkvalid">Kết xuất</button>
			</div>
		</form>
	</div>
