...
//		String nam = param.get("nam");
		...
		List<HTRaXoatSanPhamTKDTO> lstTTXL = hTRaXoatSanPhamTKService.getThongTinXuLy(nhx);
	...
	public ResponseEntity<String> doApproval(@RequestBody Hashtable<String, String> param){
		...
		int returns = hTRaXoatSanPhamTKService.doApproval(approval, maBC, ky, thang, nam, nhx, trangthai, lydoPD);
