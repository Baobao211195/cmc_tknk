...
/*
 * Modeling BaoCaoValue - Thay doi do NVHQ - Huy xoa va chi tiet theo ly do 
 */
public class ThayDoiDoNVHQNhomHuyXoaResponse {
	private String so_tk;
	private String ma_hq;
	private String ma_lh;
	private String ngay_dk;
	private String lydo_huy;
	...
	public String getLydo_huy() {
		return lydo_huy;
	}
	public void setLydo_huy(String lydo_huy) {
		this.lydo_huy = lydo_huy;
	}
	public ThayDoiDoNVHQNhomHuyXoaResponse(String so_tk, String ma_hq, String ma_lh,
			String ngay_dk, String lydo_huy) {
		super();
		this.so_tk = so_tk;
		this.ma_hq = ma_hq;
		this.ma_lh = ma_lh;
