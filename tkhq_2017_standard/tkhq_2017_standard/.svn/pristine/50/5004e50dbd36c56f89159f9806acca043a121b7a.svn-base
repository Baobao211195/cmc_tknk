...
public class DanhMucController {
	...
	@RequestMapping(value = "DSMatHangChuYeuMATHKE", method = RequestMethod.GET)
	public ResponseEntity<List<DanhMucChung>> getDSMatHangChuYeuMaThKe(String nhx){
		List<DanhMucChung> list = repository.getDSMatHangChuYeuMaThKe(nhx);
		if(list == null)
			return new ResponseEntity<List<DanhMucChung>>(HttpStatus.NOT_FOUND);
		return new ResponseEntity<List<DanhMucChung>>(list, HttpStatus.OK);
	}
