...
public class SLTheoCTTK08DataKy {
	private List<DataKyObj> data;
	private String ss_ky_truoc=" ";
	private String ss_ky_nam_truoc=" ";
	private String trend=" ";
	private String forecast=" ";
	public SLTheoCTTK08DataKy() {
		// TODO Auto-generated constructor stub
		data = new ArrayList<DataKyObj>();
	}
	public SLTheoCTTK08DataKy(List<DataKyObj> data, String ss_ky_truoc, String ss_ky_nam_truoc, String trend,
			String forecast) {
		this.data = data;
