	...
	<section class="content">
		<form name="searchForm">
			<table style="width: 100%; margin: 10px 10px 10px 10px;">
				<tr>
					<td class="col-md-6 pad10"><label class="col-md-4">Trạng
					...
					<td class="col-md-6 pad10"><label class="col-md-4">Nhóm: </label>
						<div class="col-md-8">
							<select class="form-control"
								ng-options="group as group.groupCode for group in tbsSysUserCtrl.lstNhomNSD"
								ng-model="findGroup">
							</select>
						</div></td>
				</tr>
				<tr>
					<td class="col-md-6 pad10"><label class="col-md-4">Tên đăng
							nhập: </label>
						<div class="col-md-8">
							<input type="text" name="userName" class="form-control"
								ng-model="userName" />
						</div></td>
					<td class="col-md-6 pad10"><label class="col-md-4">Tên đầy
							đủ: </label>
						<div class="col-md-8">
							...
							class="form-control" /> <span class="error"
								ng-show="searchForm.fullName.$error.pattern">Họ và tên
								không được có ký tự đặc biệt</span>
						</div></td>
				</tr>
				<tr>
				<td class="col-md-6 pad10"><label class="col-md-4">Tổng cục/Cục Hải quan </label>
						<div class="col-md-8">
							<select class="form-control"
					...
					<td class="col-md-6 pad10"><label class="col-md-4">Chi cục: </label>
						<div class="col-md-8">
							<select class="form-control"
													ng-options="chicuc as chicuc.ten for chicuc in tbsSysUserCtrl.lstChiCuc | orderBy:'ma'"
													ng-model="ChiCuc" ng-change=""></select><span class="error"
								ng-show="searchForm.fullName.$error.pattern">Họ và tên
								không được có ký tự đặc biệt</span>
						</div></td>
					<!-- <td class="col-md-6"><label class="col-md-4">Đơn vị
							hải quan: </label>
						<div class="col-md-8">
							<select class="form-control"
		...
		<div class="form-group row form-btn-align">
							<button type="submit" id="addRow" ng-click="Search()"
								class="btn btn-primary" ng-disabled="searchForm.$invalid">
								<i class="glyphicon icon-white"></i>Tìm kiếm
							</button>
						</div>
		</div>
		<div class="col-md-12">
			<div class="col-md-4">Tổng số {{tbsSysUserCtrl.lstUser.length}}
				bản ghi</div>
		</div>
		<div class="modal-body">
				<div class="box-body ">
								...
								<tr ng-repeat="row in phantrang | orderBy:'userId'">
									...
									<td align="center" style="display: inline-flex;">
										<button type="button"
											...
											class="btn btn-primary custom-width" data-toggle="modal"
					...
					<div class="col-md-12">
					<div class="col-md-2">Trang {{currentPage}} /
						{{totalPage}}</div>
					<div class="col-md-6">
						...
						<pagination total-items="tbsSysUserCtrl.lstUser.length"
			...
			<div class="form-group row form-btn-align col-md-12"
				...
				<button type="submit" id="addRow" ng-click="addRow()"
					class="btn btn-primary" data-toggle="modal" data-target="#myModal" data-backdrop="static">
							...
							<div class="form-search">
								<div class="container-fluid">
									<div class="col-md-12 pad10" style="margin-bottom: 10px;">
										<div class="col-md-6 pad10">
											...
											<div class="col-md-8 pad10">
												<input type="text" name="txtUser" class="form-control"
													value="" ng-pattern="/^[a-zA-Z0-9_]*$/" ng-minlength="3" autocomplete="off"
										...
										<div class="col-md-6 pad10">
											<label class="col-md-4 pad10">Họ và tên : </label>
											<div class="col-md-8 pad10">
												<input type="text" name="txtFullname" class="form-control"  autocomplete="off"
													ng-maxlength="100" ng-minlength="2" value=""
													ng-pattern="/^[A-Za-zÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚÝàáâãèéêìíòóôõùúýĂăĐđĨĩŨũƠơƯưẠ-ỹ0-9&._ ]*$/"
													ng-model="tbsSysUserCtrl.entity.fullName" ng-required=true
													...
													đăng nhập quá ngắn hoặc quá dài</span> <span class="error"
													ng-show="userForm.txtFullname.$error.pattern">Họ và
													tên không được có ký tự đặc biệt</span>
											</div>
										</div>
									</div>
									<div class="col-md-12 pad10" style="margin-bottom: 10px;"
										...
										<div class="col-md-6 pad10">
											...
											<div class="col-md-8 pad10">
												<input type="password" name="txtPassword"  autocomplete="off"
													class="form-control" ng-change="changePass()"
													ng-model="tbsSysUserCtrl.entity.password" value=""
													ng-minlength="8" ng-maxlength="255" /> <span class="error"
													ng-show="blankPass">Vui lòng nhập mật khẩu</span> <span
													class="error"
													ng-show="userForm.txtPassword.$error.minlength"> Mật
													khẩu phải trên 8 ký tự</span> <span class="error"
													ng-show="formatPass">Mật khẩu không đúng định dạng</span>
											</div>
										</div>
										<div class="col-md-6 pad10">
											<label class="col-md-4 pad10">Xác nhận mật khẩu : </label>
											<div class="col-md-8 pad10">
												<input type="password" name="txtCFPassword" value=""  autocomplete="off"
													ng-model="confirmpassword" class="form-control" ng-change="changeCfPass()"
									...
									<div class="col-md-12 pad10" style="margin-bottom: 10px;">
										<div class="col-md-6 pad10">
											<label class="col-md-4 pad10">Tổng cục/Cục Hải quan : </label>
											<div class="col-md-8 pad10">
												<select class="form-control"
													ng-options="cuc as cuc.ten for cuc in tbsSysUserCtrl.lstCucHQ | orderBy:'ma'"
													ng-model="cucHQ"
									...
									<div class="col-md-12 pad10" style="margin-bottom: 10px;">
										<div class="col-md-6 pad10">
											...
											<div class="col-md-8 pad10">
												<input type="email" name="txtEmailHQ" class="form-control"
													ng-pattern="/^([a-zA-Z0-9_.+-])+@custom\.gov\.vn$/"
													ng-model="tbsSysUserCtrl.entity.emailHQ" /> <span
													class="error"
													ng-show="userForm.txtEmailHQ.$error.email&&userForm.txtEmailHQ.$error.pattern">Email
										...
										<div class="col-md-6 pad10">
											...
											<div class="col-md-8 pad10">
												<input type="email" name="txtEmailKhac" class="form-control" ng-change="inputemailKhac()"
													ng-model="tbsSysUserCtrl.entity.emailKhac" /> <span
													class="error col-md-1"
													ng-hide="hidecheckemail">Email
									...
									<div class="col-md-12 pad10" style="margin-bottom: 10px;">
										<div class="col-md-6 pad10">
											...
											<div class="col-md-8 pad10">
												<select class="form-control"
													ng-options="gr as gr.groupCode for gr in lstNhom"
